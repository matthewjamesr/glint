                ...
                <div class="border">
                    ...
                    <div class="row news front-page">
                        @foreach ($news as $news)
                            @if ($news['type'] == 'video')
                                <a href="{{ $news['video_url'] }}" class="col-sm-6" style="margin-top: 0px;" target="_blank">
                            ...
                            @elseif ($news['type'] == 'article')
                                <a href="/{{ strtolower($news['country']) }}/{{ str_replace(' ', '_', $news['title']) }}" class="col-sm-6" style="margin-top: 0px;">
